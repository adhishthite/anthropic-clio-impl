...
Does the backend also have a limit

### Prompt 3

what diff between streaming and non streaming mode?

### Prompt 4

NOw I have a job running at `MlfPbvlUhCLF` -- but it's 50k records and might not compelte .. can I stop it and still retain the completed data.. at 28k ?

### Prompt 5

no.. let it be ON.. but I want to advance to the next step once I stop it.. I am happy with the 28k responses

### Prompt 6

okay it's at around 31k now.. i will wait until I have to leave and then do this..

### Prompt 7

it's at 40k now.. stop it.. and create as if it's compelte.. check and verify
...
check progress on the embedding
...
i lost my internet mid session

### Prompt 17

Okay damn.. let's embed it again..
...
can we send 100 at once?

### Prompt 20

stop.. update the config.. start again ..
...
stop all embeddings commands

### Prompt 26

okay now start.. I think we're stable..
...
While that's running.. can you fix the tests etc..the push failed..

### Prompt 33

no the actions failed

### Prompt 34

dont' amend.. just push
